...
struct PromptGenerator {
    ...
    static let templates: [ExerciseTemplate] = [
        .init(name: "Push-ups", kind: .pushUps, unit: .reps,
        ...
        .init(name: "Jumping jacks", kind: .jumpingJacks, unit: .reps,
              easy: 20...40, moderate: 35...70, hard: 60...120,
              formCue: "Light feet, steady breathing.",
              easierOption: "Step jacks (no jumping)"),

        .init(name: "Mountain climbers", kind: .mountainClimbers, unit: .reps,
    ...
    static func makeWorkout(allowedDifficulties: Set<Difficulty>, beginnerFriendly: Bool) -> Workout {
        ...
        return Workout(title: title, minutes: 1, difficulty: difficulty, equipment: .none, exerciseKind: template.kind, steps: steps)
    }
